layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'gongyingshangName', title: '供应商名称',width:'7%',totalRowText: '合计'},
            ...
            {field: 'tiaomamiaoshu', title: '产品名称',width:'14%',align:'center'},
            {field: 'fayunshuliang', title: '发运数量',width:'6%',align:'center',totalRow: true},
            {field: 'shuilv', title: '税率',width:'6%',align:'center'},
