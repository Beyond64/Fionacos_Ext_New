	...
	<script type="text/javascript">
	      ...
	      function showsel(){
	        ...
	        // area=encodeURI(area);
	         ...
	         if(datestart==""||datestop==""){
              ...
              window.location.href= "page/supplier/gongyingshang_sel_brand.jsp?datestart="+datestart+"&datestop="+datestop+"&brand="+brand+"&imdsc1="+imdsc1+"&statu=2";
       ...
       function exportReport(){  
	         ...
	         //top.window.showContentiFrame("admin/ext/gongyingshang_sel.jsp?datestart="+datestart+"&datestop="+datestop);
	          var url="<%=basePath%>export/exportGongYingShangSelByBrand?datestart="+datestart+"&datestop="+datestop
	          +"&gongyingshang="+un+"&brand="+brand+"&imdsc1="+imdsc1;

			   // var link= $('<a href="'+url+'" download="'+ datestart +'至'+datestop +'品牌销售/库存报表.xls'+'"></a>');
			   // link.get(0).click();
			   // link.remove();
           loadDown(url);
                ...
                <% 
			        ...
			        for (Params params : list) {
                     ...
                     /*
	                    ...
	                    imdsc1 =URLEncoder.encode(imdsc1,"utf-8");
	                    //183.11.241.154:8081	192.168.15.252:818
						String url = "http://183.11.241.154:8081/Fionacos/admin/ext/getext_json_kucun.jsp?datestart="+
						datestart.trim()+"&datestop="+datestop.trim()+"&gongyingshang="+
						un+"&brand="+brand+"&imdsc1="+imdsc1;
						System.out.println(url+">>>");
				        String json = pjp.loadJSON(url);
