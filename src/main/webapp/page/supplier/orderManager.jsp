...
<form class="layui-form" >
    ...
    <script type="text/html" id="state">
        {{#  if(d.orderStatus == 'N'){ }}
        <span>待审批</span>
        {{#  } else if(d.orderStatus == 'F'){ }}
        <span class="layui-blue">已发货</span>
        {{#  } else if(d.orderStatus == 'S'){ }}
        <span class="layui-red">已作废</span>
        {{#  } else if(d.orderStatus == 'Y'){ }}
        <span class="layui-blue">已审批</span>
        {{#  }}}
    </script>

    <!--操作-->
    <script type="text/html" id="newsListBar">
        {{#  if(d.orderStatus == 'Y' || d.orderStatus == 'F'){ }}
        ...
        <a class="layui-btn layui-btn-xs layui-btn-disabled">导出</a>
        {{#  }}}
    </script>
</form>
