	      ...
	      function showsel(){
	        ...
	        // area=encodeURI(area);
	         ...
	         if(datestart==""||datestop==""){
              ...
              window.location.href= "page/supplier/gongyingshang_sel_z.jsp?datestart="+datestart+"&datestop="+datestop+"&area="+area+"&mcdc="+mcdc+"&brand="+brand+"&imdsc1="+imdsc1+"&statu=2";
