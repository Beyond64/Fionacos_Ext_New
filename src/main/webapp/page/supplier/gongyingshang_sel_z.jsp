	      ...
	      function showsel(){
	        ...
	        // area=encodeURI(area);
	         ...
	         if(datestart==""||datestop==""){
              ...
              window.location.href= "page/supplier/gongyingshang_sel_z.jsp?datestart="+datestart+"&datestop="+datestop+"&area="+area+"&limcu="+limcu+"&mcdc="+mcdc+"&brand="+brand+"&imdsc1="+imdsc1+"&statu=2";
       ...
       function exportReport(){  
           ...
           limcu=encodeURI(limcu);
	         ...
	         //top.window.showContentiFrame("admin/ext/gongyingshang_sel.jsp?datestart="+datestart+"&datestop="+datestop);
	          var url="<%=basePath%>export/exportGongYingShangSel_Z?datestart="+datestart+"&datestop="+datestop
	          +"&gongyingshang="+un+"&area="+area+"&limcu="+limcu+"&mcdc="+mcdc+"&brand="+brand+"&imdsc1="+imdsc1;
		   loadDown(url);
       }
              ...
              <div id="data_tab">
                ...
                <% 
                   if(!statu.equals("1")){
					...
					un+"&area="+area+"&limcu="+limcu+"&mcdc="+mcdc+"&brand="+brand+"&imdsc1="+imdsc1;
			        ...
			        for (Params params : list) { 
													               ...
													               tablestr+="<td>"+params.getParam12()+"</td>";
													               ...
													               kucunOnQty+=Integer.parseInt(params.getParam12());
                     ...
                     out.write("<script type=\"text/javascript\">  $(\"#hide_div\").hide();</script>");	
				        ...
				        */
				        ...
				        for (Params params : list) {
				           kucunqty+=Integer.parseInt(params.getParam7()); 
					       sqleqty+=Integer.parseInt(params.getParam10());
						   kucunOnQty+=Integer.parseInt(params.getParam11());
						   countst++; 
				        }
