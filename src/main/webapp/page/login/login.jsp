...
<head>
    ...
    <link rel="icon" href="../../images/sys_ico.png" type="image/x-icon" title="妍丽.信息中心技术支持">
...
<form class="layui-form">
    ...
    <div class="login_face"><img src="../../images/sys_ico.png" class="userAvatar" style="width: 100%;height: 100%"></div>
    ...
    <div class="layui-form-item">
        <button class="layui-btn layui-block" type="button" id="loginBtn" lay-filter="login" lay-submit>登录</button>
    </div>
</form>
