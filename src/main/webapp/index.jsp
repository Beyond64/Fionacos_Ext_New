...
<head>
    ...
    <link rel="icon" href="${pageContext.request.contextPath}/images/sys_ico.png" type="image/x-icon" title="妍丽.信息中心技术支持">
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="images/sys_ico.png" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">${user.nickname}</cite></a>
                    <dl class="layui-nav-child">
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="images/sys_ico.png" class="userAvatar"></a>
            <p><span class="userName" id="nickname">${user.nickname}</span></p>
        </div>
        <!-- 搜索 -->
        <div class="layui-form component">
            <select name="search" id="search" lay-search lay-filter="searchPage">
                <option value="">搜索页面或功能</option>
                <option value="1">功能正在开发中</option>
            </select>
            <i class="layui-icon">&#xe615;</i>
        </div>
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree left-tree">
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2018 妍丽•信息中心</span></p>
    </div>
</div>
